...
static int exynos_tmu_read(struct exynos_tmu_data *data)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE, "[TMU] TMU0 = %d, TMU1 = %d, TMU2 = %d, TMU3 = %d, TMU4 = %d\n", alltemp[0], alltemp[1], alltemp[2], alltemp[3], alltemp[4]);
...
static irqreturn_t exynos_tmu_irq(int irq, void *id)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE, "[TMUIRQ] irq = %d\n", irq);
